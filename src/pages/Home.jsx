                ...
                <div className="grid gap-5 lg:grid-cols-3">
                    ...
                    <div className="space-y-5">
                        <div className="shadow rounded-xl overflow-hidden">
                            {/*<div className="h-32 bg-cover" style="background-image: url('assets/img/cover.jpg');"></div>*/}
                            <div className="h-32 bg-cover bg-gradient-to-r from-cyan-500 to-blue-500"></div>
                            <div className="pt-14 p-7 bg-white relative">
                                <span className="status-badge bg-gray-400">Available</span>
                                {/* Profile photo */}
                                <a href="/"><img src={profilePhoto} alt="Avatar" className="user-photo"/></a>
                                <div className="text-lg font-semibold mb-1.5">Dylan Sharp</div>
                    ...
                    <div className="space-y-5 lg:col-span-2">
                        ...
                        <div className="p-7 pb-0 block-section">
                            ...
                            <p className="text-gray-600 mb-5">Libero quas veritatis nulla distinctio fuga nihil
                                temporibus et. Quia dicta sapiente qui porro molestiae nobis incidunt voluptatem. Et
                                voluptas sunt nihil. At perferendis voluptatem dolores nulla. Adipisci dolore non.
                                Praesentium ipsa magnam ut quia explicabo voluptates.</p>
                            ...
                            <ul className="flex space-x-8 font-medium">
                                ...
                                <li>
                                    <a href="/public/products.html" className="menu-link menu-link-hover">Products</a>
                                </li>
                                <li>
                                    <a href="/public/blog.html" className="menu-link menu-link-hover">Blog</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div className="mb-5 item-section">
                                ...
                                <div className="w-full space-y-5">
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        saepe asperiores beatae voluptate corporis est ea voluptatem. Enim quo sed et
                                        sint aspernatur distinctio qui quam.
                                    </p>
